...
public class vistaJugador extends JFrame implements ActionListener {
    ...
    private JLabel nivelLabel, pistaLabel;
    ...
    public vistaJugador() {
        ...
        imm[0] = new ImageIcon(getClass().getResource("/ADIVINAYSALVATE/1.PNG"));
        imm[1] = new ImageIcon(getClass().getResource("/ADIVINAYSALVATE/2.PNG"));
        imm[2] = new ImageIcon(getClass().getResource("/ADIVINAYSALVATE/3.PNG"));
        imm[3] = new ImageIcon(getClass().getResource("/ADIVINAYSALVATE/4.PNG"));
        imm[4] = new ImageIcon(getClass().getResource("/ADIVINAYSALVATE/5.PNG"));
        imm[5] = new ImageIcon(getClass().getResource("/ADIVINAYSALVATE/6.PNG"));
